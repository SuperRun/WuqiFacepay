...
import com.wuqi.facepay.api.FaceApi;
import com.wuqi.facepay.callback.CameraDataCallback;
import com.wuqi.facepay.callback.FaceDetectCallBack;
import com.wuqi.facepay.callback.FaceFeatureCallBack;
import com.wuqi.facepay.camera.AutoTexturePreviewView;
import com.wuqi.facepay.camera.CameraPreviewManager;
import com.wuqi.facepay.manager.FaceSDKManager;
import com.wuqi.facepay.manager.FaceTrackManager;
import com.wuqi.facepay.model.GlobalSet;
import com.wuqi.facepay.model.LivenessModel;
import com.wuqi.facepay.model.SingleBaseConfig;
import com.wuqi.facepay.ui.BaseActivity;
import com.wuqi.facepay.ui.carousel.CarouselActivity;
import com.wuqi.facepay.util.BitmapUtils;
import com.wuqi.facepay.util.FileUtils;
import com.wuqi.facepay.util.ImageUtils;
import com.wuqi.facepay.views.CircleImageView;
...
public class FaceRGBRegisterActivity extends BaseActivity implements View.OnClickListener {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_face_rgb_register);
        Log.d(TAG, "== onCreate ==");
...
//         CameraPreviewManager.getInstance().setCameraFacing(CameraPreviewManager.CAMERA_FACING_BACK);
        ...
        Log.d(TAG, "mPreviewView="+mPreviewView);
    ...
    private void faceDetect(byte[] data, final int width, final int height) {
        ...
        FaceTrackManager.getInstance().faceTrack(data, width, height, new FaceDetectCallBack() {
            ...
            public void onFaceDetectCallback(LivenessModel livenessModel) {
                ...
                Log.d(TAG, "onFaceDetectCallback: isFilterSuccess="+isFilterSuccess);
                if (isFilterSuccess) {
                    // 展示model
    ...
    private void showDetectImage(byte[] rgb) {
        Log.d(TAG, "showDetectImage: ");
        if (rgb == null) {
            return;
        }
        Log.d(TAG, "showDetectImage: "+SingleBaseConfig.getBaseConfig().getDetectDirection());
