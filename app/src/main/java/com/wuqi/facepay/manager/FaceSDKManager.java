...
import com.wuqi.facepay.db.DBManager;
...
import com.wuqi.facepay.model.User;
...
import static com.wuqi.facepay.model.GlobalSet.FEATURE_SIZE;
...
public class FaceSDKManager {
    ...
    public void onDetectCheck(final byte[] rgbData,
        ...
        future = es.submit(new Runnable() {
            ...
            public void run() {
                ...
                Log.e(TIME_TAG, "detect vis time = " + livenessModel.getRgbDetectDuration());
        ...
        future2 = es2.submit(new Runnable() {
            ...
            public void run() {
                ...
                if (liveCheckMode != 1) {
                    ...
                    Log.e(TIME_TAG, "live rgb time = " + livenessModel.getRgbLivenessDuration());
                }
                ...
                if (liveCheckMode == 3 && nirData != null) {
                    ...
                    Log.e(TIME_TAG, "detect ir time = " + livenessModel.getIrLivenessDuration());
                    ...
                    if (faceInfosIr != null && faceInfosIr.length > 0) {
                        ...
                        Log.e(TIME_TAG, "live ir time = " + livenessModel.getIrLivenessDuration());
                    }
                    nirInstance.destory();
                }
                ...
                if (liveCheckMode == 4 && depthData != null) {
                    ...
                    Log.e(TIME_TAG, "live depth time = " + livenessModel.getDepthtLivenessDuration());
                ...
                Log.e(TIME_TAG, "all process time = " + livenessModel.getAllDetectDuration());
                // 流程结束销毁图片，开始下一帧图片检测，否着内存泄露
                rgbInstance.destory();
                // 显示最终结果提示
                if (faceDetectCallBack != null) {
    ...
    public void onFeatureCheck(BDFaceImageInstance rgbInstance,
        ...
        Log.e(TIME_TAG, "feature live time = " + livenessModel.getFeatureDuration());
        ...
        if (featureSize == FEATURE_SIZE / 4) {
            ...
            Log.e(TIME_TAG, "feature search time = " + livenessModel.getCheckDuration());
        }
    }
